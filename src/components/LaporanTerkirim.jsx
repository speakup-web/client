...
export function LaporanTerkirim() {
    ...
    <section className="max-w-screen-lg mx-auto mt-20 px-4 sm:px-6 space-y-5" id='LaporanTerkirim1'>
        ...
        <div className='mt-3 mb-10 flex justify-center items-center'>
            <button type="submit" className="text-white hover:bg-blue-300 focus:ring-4 focus:outline-none font-medium rounded-full text-sm flex items-center justify-center w-full sm:w-auto px-20 py-3 my-4 mb-20 mr-4 text-center dark:hover:bg-blue-600 bg-blue-500 poppins-semibold">
