...
export function Information() {
  return (
    <section className="bg-babyBlue py-16 text-center" id="information">
      ...
      <p className="text-gray-600 inter-extra-light">
        Tata Cara Membuat Pengaduan Melalui SpeakUp!
      </p>
      <div className="flex flex-wrap justify-center py-10">
        {tatacara.map((cara) => (
          <div
            key={cara.id}
            className="bg-white p-8 rounded-md shadow-md max-w-lg mx-4 my-6 flex text-start"
          >
            ...
            <div className="flex-grow">
              <div className="px-4">
                <h3 className="text-lg font-semibold text-gray-900 pb-2 nunito-bold red">
                  {cara.title}
                </h3>
                <p className="text-sm text-gray-800 nunito-light">
                  {cara.desc}
                </p>
              </div>
            </div>
