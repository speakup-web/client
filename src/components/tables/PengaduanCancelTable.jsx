...
function PengaduanCancelTable() {
    const filteredPengaduan = pengaduan.filter(pengaduanItem => pengaduanItem.status_pengaduan.cancelled === true);
...
export default PengaduanCancelTable;
